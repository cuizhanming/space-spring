...
There will be slightly different between models used for api users, so that we will have a set of different DTOs represent for different usage.

1.1.0 To save boilerplate code for POJO. We choose lombok  
1.1.1 The translation between domain and DTOs are done by mappers. We choose [MapStruct](https://mapstruct.org/) as our solution framework.
