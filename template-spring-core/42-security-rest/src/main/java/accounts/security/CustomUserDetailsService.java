...
//xTODO-13 (Optional): Create custom UserDetailsService
...
//xTODO-14a (Optional): Add authentication based upon the custom UserDetailsService
//- Annotate the class with @Component to make it a Spring manager bean

//xTODO-18b (Optional): Remove the CustomUserDetailsService definition
