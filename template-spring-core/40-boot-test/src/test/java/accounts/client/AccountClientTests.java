...
public class AccountClientTests {
	...
	public void getAccount() {
		Account account = restTemplate.getForObject("/accounts/{accountId}", Account.class, 0);
	...
	public void createAccount() {
		...
		URI newAccountLocation = restTemplate.postForLocation("/accounts", account);
	...
	public void addAndDeleteBeneficiary() {
		...
		var responseEntity = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
