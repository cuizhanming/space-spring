...
import com.cuizhanming.multidatasource.gcp.repository.cassandra.CredentialCassandraRepository;
...
@RestController
@RequestMapping("/data")
public class CredentialCassandraController {

    @Autowired
    CredentialCassandraRepository credentialRepository;
