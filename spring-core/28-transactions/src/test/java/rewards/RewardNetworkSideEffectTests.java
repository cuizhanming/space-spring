 ...
 *
 * xTODO-08: MAKE SURE to revert the propagation attribute back to
 * REQUIRED in RewardNetworkImpl.
 *
 * xTODO-09: Examine the @Test logic below. Note that committed results from the
 ...
 *
 * xTODO-10: Add @Transactional on the class and re-run the test. It should pass.
 * Do you know why?
 */
